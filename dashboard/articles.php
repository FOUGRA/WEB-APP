    ...
    <div class="wrapper">
        ...
        <div class="blocktopheader">
            <?php 
                ...
                ?>
            <div class="blocTitle">
                <h4 class="titreTabs"><i class="fal fa-cart-arrow-down"></i> Articles Consommable </h4>
            ...
            <div class="bloccentent">
                ...
                <table class="table tabledetaillevoyage" id="cart">
                    ...
                    <tbody>
                        <?
                              $query = "SELECT * FROM fsj_articles order by id_ar desc";
                        ...
                        <tr>
                            ...
                            <td class="right">
                                <span class="inlineblock primary" data-toggle="tooltssip" data-placement="top" title="Modifier">
                                    <a class="deletebtn btn btn-primary btn-xs btnUpdateM" data-toggle="modal" data-id="<?php  echo $article['id_ar']; ?>" data-target="#UpdateM">
                                        <i class="fal fa-edit"></i>
                                    </a>
                                </span>
                                <?
                                    $id_ar = $article['id_ar'] ;
                                     $sql_queryex = "select  count(*) as idexist from fsj_stocks where id_ar='$id_ar'";
                                      $result = mysqli_query( $db, $sql_queryex );
                                    $row = mysqli_fetch_array( $result );
                                    $count = $row['idexist'];
                                    if($count == 0 ){
                                        ?>
                                <span class="inlineblock" data-toggle="tooltsip" data-placement="top" title="Supprimer">
                                    <a class="deletebtn btn btn-danger btn-xs btndelete" data-toggle="modal" data-nom="<?php  echo $article['des_art']; ?>" data-id="<?php  echo $article['id_ar']; ?>" data-target="#deleteM">
    ...
    <div class="modal fade" id="addM" role="dialog" data-backdrop="static" data-keyboard="false">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form class="form-horizontal" method="post" action="../config/articles.php" enctype="multipart/form-data">
                    <div class="modal-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" value="Consommable" disabled>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <select class="form-control" name="categorie" id="categorie" required>
                                    ...
                                    <?
                                  $queryGF = "SELECT * FROM fsj_categories where type='Consommable' order by description asc";
                        ...
                        <div class="form-group row">
                            <label class="col-sm-4 col-form-label" for="alert">Alert : <span class="oblig">*</span></label>
                            <div class="col-sm-8">
                                <input type="number" min="1" max="100" class="form-control" id="alert" name="alert" placeholder="alert" required>
                            </div>
                        </div>
                    </div>
            ...
            <div class="modal-content">
                ...
                <form class="form-horizontal" method="post" action="../config/articles.php" enctype="multipart/form-data">
                    <div class="modal-body">
                        ...
                        <div class="form-group row">
                            <label class="col-sm-4 col-form-label" for="alertU">Alert : <span class="oblig">*</span></label>
                            <div class="col-sm-8">
                                <input type="number" min="1" max="100" class="form-control" id="alertU" name="alertU" required>
                            </div>
                        </div>
                    </div>
                    <div class="modal-footer">
    ...
    <div class="modal fade" id="deleteM" role="dialog" data-backdrop="static" data-keyboard="false">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="../config/articles.php" method="post">
                    <div class="modal-footer">
...
*/
            ...
            $("#homeSubmenu .sidebarC").addClass('active');
            ...
            $(".btnUpdateM").click(function() {
                ...
                $.post("../config/articles.php", $datas, function(datas) {
                    var getdats = $.parseJSON(datas);
                    $("#id_arU").val(getdats['id_ar']);
                    $("#des_artU").val(getdats['des_art']);
                    $("#uniteUO").html(getdats['unite']);
                    $("#categorieUO").html(getdats['categorie']);
                    //  $("#categorieU").append("<option>" + getdats['categorie'] + "</option>")
                    $("#alertU").val(getdats['alert']);
                });
