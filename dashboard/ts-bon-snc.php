        ...
        <div class="blocktopheader">
            ...
            <div class="bloccentent">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <ul class="nav nav-tabs">
                                <li class="nav-item">
                                    <a class="nav-link" aria-current="page" href="/dashboard/bon-snc.php"><i class="fal fa-person-dolly"></i> Faire un bon de sortie</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link active" href="/dashboard/ts-bon-snc.php"><i class="fal fa-shipping-fast"></i> Tous les bon de sortie</a>
                                </li>
                ...
                <table class="table tabledetaillevoyage" id="cart">
                    ...
                    <tbody>
                        <?
                              $query = "SELECT * FROM fsj_bsnc order by id_bsnc desc";
                              $bss = $db->query($query);
                                foreach ($bss as $bs) {
                        ...
                        <tr>
                            ...
                            <td class="right">
                                ...
                                <span class="inlineblock primary" data-toggle="tooltip" data-placement="top" title="Afficher">
                                    <form action="/dashboard/bsnc-print.php" method="post">
                                        <input type="hidden" name="id_bs" value="<?php  echo $bs['id_bsnc']; ?>">
                                ...
                                <span class="inlineblock" data-toggle="tooltsip" data-placement="top" title="Supprimer">
                                    <a class="deletebtn btn btn-danger btn-xs btndelete" data-toggle="modal" data-id="<?php  echo $bs['id_bsnc']; ?>" data-target="#deleteM">
